...
output_path = r"C:\Users\1995e\OneDrive\Desktop\Downloads\STS2\structure_10_levels.csv"

def explore(data, parent_key="", level=1, max_level=10, rows=None):
    if rows is None:
        rows = []
...
for file in os.listdir(data_path):
    if file.endswith(".run"):
        ...
        rows = explore(data, max_level=10)
